...
class LoanServiceImpl implements LoanService {
     ...
     */
    @Override
    public void save(LoanDto loan) throws Exception {
        ...
        List<Loan> gameConflicts = loanRepository.findOverlappingByGame(loan.getGame().getId(), loan.getStartDate(), loan.getEndDate(), excludeId);
        ...
        List<Loan> clientLoans = loanRepository.findOverlappingByClient(loan.getCustomer().getId(), loan.getStartDate(), loan.getEndDate(), excludeId);
        ...
        newLoan.setGame(gameRepository.findById(loan.getGame().getId()).orElseThrow());
        newLoan.setCustomer(customerRepository.findById(loan.getCustomer().getId()).orElseThrow());
